...
#ifndef ASCTILE_CONVERSION_LOWERTOASC_PASSES_H
#define ASCTILE_CONVERSION_LOWERTOASC_PASSES_H
...
std::unique_ptr<Pass> createLowerAscTileDataTransferPass();
std::unique_ptr<Pass> createLowerAscTileToBasicPass();
...
#endif // ASCTILE_CONVERSION_LOWERTOASC_PASSES_H
