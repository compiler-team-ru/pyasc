...
// RUN: asctile-opt -ascendc-insert-bufid-sync %s | FileCheck %s
...
// CHECK-NEXT:  ascendc.data_copy_l2 %0, %arg0, %c256_i32 {ascendc.buf_ids = [0 : i32], direction = #ascendc.copy_direction<gm, veccalc>} : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, i32
...
func.func @data_copy_gm_to_tbuf(%arg0: !ascendc.global_tensor<*xf32>, %arg1: !ascendc.tbuf<vecin>) {
  ...
  ascendc.data_copy_l2 %tensor, %arg0, %c256 {direction = #ascendc.copy_direction<gm, veccalc>} : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, i32
  return
}
...
// CHECK-NEXT:  ascendc.data_copy_l2 %arg0, %0, %c256_i32 {ascendc.buf_ids = [0 : i32], direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
...
func.func @data_copy_tbuf_to_gm(%arg0: !ascendc.global_tensor<*xf32>, %arg1: !ascendc.tbuf<vecin>) {
  %c256 = arith.constant 256 : i32
  %tensor = ascendc.tbuf.get_tensor %arg1 : !ascendc.tbuf<vecin>, !ascendc.local_tensor<*xf32>
  ascendc.data_copy_l2 %arg0, %tensor, %c256 {direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
  return
}
...
// CHECK-NEXT:  ascendc.rls_buf pipe_v, 0
// CHECK-NEXT:  ascendc.get_buf pipe_mte3, 0
// CHECK-NEXT:  ascendc.data_copy_l2 %arg2, %0, %c256_i32 {ascendc.buf_ids = [0 : i32], direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
// CHECK-NEXT:  ascendc.rls_buf pipe_mte3, 0
// CHECK-NEXT:  return
// CHECK-NEXT:}
func.func @mixed_operations(%arg0: !ascendc.global_tensor<*xf32>, %arg1: !ascendc.local_tensor<*xf32>, %arg2: !ascendc.global_tensor<*xf32>, %arg3: !ascendc.tbuf<vecin>) {
  ...
  ascendc.data_copy_l2 %arg2, %tensor, %c256 {direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
  return
}
...
// CHECK-NEXT:  ascendc.data_copy_l2 %arg1, %1, %c256_i32 {ascendc.buf_ids = [1 : i32], direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
...
func.func @sync_mte2_vec(%arg0: !ascendc.global_tensor<*xf32>, %arg1: !ascendc.global_tensor<*xf32>, %arg2: !ascendc.tbuf<vecin>) {
  ...
  ascendc.data_copy_l2 %arg1, %tensor2, %c256 {direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
  return
}
...
// CHECK-NEXT:  ascendc.rls_buf pipe_mte2, 0
// CHECK-NEXT:  ascendc.get_buf pipe_mte3, 0
// CHECK-NEXT:  ascendc.data_copy_l2 %arg1, %0, %c256_i32 {ascendc.buf_ids = [0 : i32], direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
// CHECK-NEXT:  ascendc.rls_buf pipe_mte3, 0
// CHECK-NEXT:  return
// CHECK-NEXT:}
func.func @sync_mte2_mte3(%arg0: !ascendc.global_tensor<*xf32>, %arg1: !ascendc.global_tensor<*xf32>, %arg2: !ascendc.tbuf<vecin>) {
  ...
  %tensor = ascendc.tbuf.get_tensor %arg2 : !ascendc.tbuf<vecin>, !ascendc.local_tensor<*xf32>
  ascendc.data_copy_l2 %tensor, %arg0, %c256 {direction = #ascendc.copy_direction<gm, veccalc>} : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, i32
  ascendc.data_copy_l2 %arg1, %tensor, %c256 {direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
  return
}
...
// CHECK-NEXT:  ascendc.data_copy_l2 %1, %arg0, %c256_i32 {ascendc.buf_ids = [1 : i32], direction = #ascendc.copy_direction<gm, veccalc>} : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, i32
...
// CHECK-NEXT:  ascendc.data_copy_l2 %arg1, %3, %c256_i32 {ascendc.buf_ids = [3 : i32], direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
...
func.func @sync_vec_vec(%arg0: !ascendc.global_tensor<*xf32>, %arg1: !ascendc.global_tensor<*xf32>, %arg2: !ascendc.tbuf<vecin>, %arg3: !ascendc.tbuf<vecout>) {
  ...
  ascendc.data_copy_l2 %x_local, %arg0, %c256 {direction = #ascendc.copy_direction<gm, veccalc>} : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, i32
  ascendc.data_copy_l2 %x2_local, %arg0, %c256 {direction = #ascendc.copy_direction<gm, veccalc>} : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, i32
  ...
  ascendc.data_copy_l2 %arg1, %z2_local, %c256 {direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
  return
}
...
// CHECK-NEXT:  ascendc.data_copy_l2 %arg1, %2, %c256_i32 {ascendc.buf_ids = [2 : i32], direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
...
func.func @sync_vec_mte3(%arg0: !ascendc.global_tensor<*xf32>, %arg1: !ascendc.global_tensor<*xf32>, %arg2: !ascendc.tbuf<vecin>, %arg3: !ascendc.tbuf<vecout>) {
  ...
  ascendc.data_copy_l2 %x2_local, %arg0, %c256 {direction = #ascendc.copy_direction<gm, veccalc>} : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, i32
  ascendc.add_l2 %z_local, %x_local, %x2_local, %c256 : !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
  ascendc.data_copy_l2 %arg1, %z_local, %c256 {direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
  return
}
...
// CHECK-NEXT:  ascendc.rls_buf pipe_v, 1
// CHECK-NEXT:  ascendc.get_buf pipe_mte3, 1
// CHECK-NEXT:  ascendc.data_copy_l2 %arg2, %1, %c256_i32 {ascendc.buf_ids = [1 : i32], direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
// CHECK-NEXT:  ascendc.rls_buf pipe_mte3, 1
// CHECK-NEXT:  return
// CHECK-NEXT:}
func.func @sync_mte3_vec(%arg0: !ascendc.global_tensor<*xf32>, %arg1: !ascendc.global_tensor<*xf32>, %arg2: !ascendc.global_tensor<*xf32>, %arg3: !ascendc.tbuf<vecin>, %arg4: !ascendc.tbuf<vecout>) {
  ...
  ascendc.data_copy_l2 %x_local, %arg0, %c256 {direction = #ascendc.copy_direction<gm, veccalc>} : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, i32
  ascendc.data_copy_l2 %arg1, %x_local, %c256 {direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
  ...
  ascendc.data_copy_l2 %arg2, %z_local, %c256 {direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
  return
}
...
// CHECK-NEXT:      ascendc.rls_buf pipe_mte2, 0
// CHECK-NEXT:      ascendc.get_buf pipe_mte2, 1
// CHECK-NEXT:      ascendc.data_copy_l2 %1, %arg1, %c256_i32 {ascendc.buf_ids = [1 : i32], direction = #ascendc.copy_direction<gm, veccalc>} : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, i32
// CHECK-NEXT:      ascendc.rls_buf pipe_mte2, 1
// CHECK-NEXT:      ascendc.get_buf pipe_v, 2
// CHECK-NEXT:      ascendc.get_buf pipe_v, 0
// CHECK-NEXT:      ascendc.get_buf pipe_v, 1
...
// CHECK-NEXT:  }
// CHECK-NEXT:  ascendc.get_buf pipe_mte3, 2
// CHECK-NEXT:  ascendc.data_copy_l2 %arg2, %2, %c256_i32 {ascendc.buf_ids = [2 : i32], direction = #ascendc.copy_direction<veccalc, gm>} : !ascendc.global_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32
// CHECK-NEXT:  ascendc.rls_buf pipe_mte3, 2
// CHECK-NEXT:  return
// CHECK-NEXT:}
func.func @sync_nested_for(%arg0: !ascendc.global_tensor<*xf32>, %arg1: !ascendc.global_tensor<*xf32>, %arg2: !ascendc.global_tensor<*xf32>, %arg3: !ascendc.tbuf<vecin>, %arg4: !ascendc.tbuf<vecout>) {
  ...
  scf.for %arg5 = %c0 to %c2 step %c1 : i32 {
    scf.for %arg6 = %c0 to %c4 step %c1 : i32 {
      ascendc.data_copy_l2 %x_local, %arg0, %c256 {direction = #ascendc.copy_direction<gm, veccalc>} : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, i32
      ascendc.data_copy_l2 %y_local, %arg1, %c256 {direction = #ascendc.copy_direction<gm, veccalc>} : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, i32
