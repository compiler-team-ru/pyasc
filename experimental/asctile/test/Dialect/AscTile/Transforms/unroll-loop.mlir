...
// RUN: asctile-opt -asctile-unroll-loop -cse %s | FileCheck %s --check-prefixes=CHECK,NOANN
// RUN: asctile-opt -asctile-unroll-loop=annotate -cse %s | FileCheck %s --check-prefixes=CHECK,ANNOT
