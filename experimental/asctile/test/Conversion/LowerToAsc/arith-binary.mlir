...
// RUN: asctile-opt -asclower-arith-binary -canonicalize -split-input-file %s | FileCheck %s
...
// CHECK-NEXT:  %4 = ascendc.construct !ascendc.binary_repeat_params()
// CHECK-NEXT:  ascendc.compare_l0 %3, %1, %0, %c0_i64, %c0_i64, %4 {cmpMode = 0 : i64} : !ascendc.local_tensor<2xui8>, !ascendc.local_tensor<16xf32>, !ascendc.local_tensor<16xf32>, i64, i64, !ascendc.binary_repeat_params
// CHECK-NEXT:  %5 = builtin.unrealized_conversion_cast %3 : !ascendc.local_tensor<2xui8> to tensor<16xi1, #asctile.local<UB>>
...
// CHECK-NEXT:  ascendc.compare_l0 %5, %2, %3, %c0_i64, %c0_i64, %6 {cmpMode = 1 : i64} : !ascendc.local_tensor<2xui8>, !ascendc.local_tensor<16xf32>, !ascendc.local_tensor<16xf32>, i64, i64, !ascendc.binary_repeat_params
// CHECK-NEXT:  %7 = builtin.unrealized_conversion_cast %5 : !ascendc.local_tensor<2xui8> to tensor<16xi1, #asctile.local<UB>>
// CHECK-NEXT:  return %7 : tensor<16xi1, #asctile.local<UB>>
// CHECK-NEXT:}
...
// CHECK-NEXT:  %3 = builtin.unrealized_conversion_cast %2 : !ascendc.local_tensor<2xi8> to !ascendc.local_tensor<2xui8>
// CHECK-NEXT:  %4 = ascendc.construct !ascendc.binary_repeat_params()
// CHECK-NEXT:  ascendc.compare_l0 %3, %1, %0, %c0_i64, %c0_i64, %4 {cmpMode = 1 : i64} : !ascendc.local_tensor<2xui8>, !ascendc.local_tensor<16xi32>, !ascendc.local_tensor<16xi32>, i64, i64, !ascendc.binary_repeat_params
// CHECK-NEXT:  %5 = builtin.unrealized_conversion_cast %3 : !ascendc.local_tensor<2xui8> to tensor<16xi1, #asctile.local<UB>>
// CHECK-NEXT:  return %5 : tensor<16xi1, #asctile.local<UB>>
// CHECK-NEXT:}
