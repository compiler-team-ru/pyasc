...
// RUN: asctile-opt -asclower-arith -canonicalize %s | FileCheck %s
...
// CHECK-NEXT:  %4 = builtin.unrealized_conversion_cast %2 : !ascendc.local_tensor<4xi8> to !ascendc.local_tensor<4xui8>
// CHECK-NEXT:  ascendc.select_l2 %3, %4, %1, %0, %c0_i64 {selMode = 2 : i32} : !ascendc.local_tensor<32xf32>, !ascendc.local_tensor<4xui8>, !ascendc.local_tensor<32xf32>, !ascendc.local_tensor<32xf32>, i64
// CHECK-NEXT:  %5 = builtin.unrealized_conversion_cast %3 : !ascendc.local_tensor<32xf32> to tensor<32xf32, #asctile.local<UB>>
// CHECK-NEXT:  return %5 : tensor<32xf32, #asctile.local<UB>>
// CHECK-NEXT:}
