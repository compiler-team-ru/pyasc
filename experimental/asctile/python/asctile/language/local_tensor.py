...
RoundMode: TypeAlias = asctile.ir.asctile_RoundMode
...
class LocalTensor(IRValue):
    ...
    def __init__(self, handle: IRHandle) -> None:
        ...
        self.location: Final = asctile.ir.get_tensor_location(ir_type)
    ...
    def to(self, *args, **kwargs) -> Self:
        ...
        dispatcher = OverloadDispatcher("asctile.LocalTensor.to")
