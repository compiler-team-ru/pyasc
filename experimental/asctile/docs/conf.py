...
def setup_generated_mlir_docs():
    ...
    passes_docs = [
        ...
        ("AscTileAscendCPasses.md", "ascendcext.md", "AscendC (from AscTile extension)"),
...
project = 'PyAsc + AscTile'
current_year = datetime.datetime.now().year
copyright = f'2026-{current_year}, Huawei Technologies Co., Ltd.'
...
sphinx_gallery_conf = {
    ...
    "examples_dirs": [str(package_root / "experimental" / "asctile" / "python" / "tutorials")],
