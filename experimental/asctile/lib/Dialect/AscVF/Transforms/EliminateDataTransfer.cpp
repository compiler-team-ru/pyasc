...
SmallVector<emitasc::VFForOp> getLoops(ascvf::VFGroupOp groupOp)
{
    SmallVector<emitasc::VFForOp> loops;
    groupOp.walk([&](emitasc::VFForOp forOp) { loops.emplace_back(forOp); });
    return loops;
}
