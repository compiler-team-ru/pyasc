...
void pyasc_bind_enums(py::module &m)
{
    ...
    py::enum_<asctile::AtomicKind>(m, "AtomicKind", py::module_local())
        ...
        .def_static("symbolize",
                    [](int32_t kind) -> asctile::AtomicKind { return static_cast<asctile::AtomicKind>(kind); });
    ...
    py::enum_<asctile::CompareMode>(m, "CompareMode", py::module_local())
        ...
        .def_static("symbolize",
                    [](uint8_t mode) -> asctile::CompareMode { return static_cast<asctile::CompareMode>(mode); });
}
