...
import asc2
from asc2.language.utils import constant_tile
import pytest


@pytest.fixture
def jit_test():
    return asc2.jit(always_compile=True, capture_exceptions=False)
...
def zero_tile():
    ...
    def zeros(shape: Tuple[int, ...], dtype: asc2.DataType = asc2.float32,
              loc: asc2.TensorLocation = asc2.TensorLocation.UB, *, n: int = 1):
...
@pytest.fixture
def scalar_value() -> Callable[[asc2.DataType], Union[int, float]]:
