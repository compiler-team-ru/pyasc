...
compare_valid_dtypes = (asctile.int8, asctile.int16, asctile.int32, asctile.float16, asctile.bfloat16, asctile.float32)
bitwise_valid_dtypes = (asctile.int8, asctile.int16, asctile.int32, asctile.int64)
shift_valid_dtypes = (asctile.int16, asctile.int32, asctile.int64)
...
class BinaryOpSpec:
    fn: Callable
    valid_dtypes: Tuple[asctile.DataType, ...] = (asctile.int16, asctile.int32, asctile.int64, asctile.float16,
                                                  asctile.bfloat16, asctile.float32)
...
specs = (
    BinaryOpSpec(fn=asctile.add, operator_fn=operator.add, invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.sub, operator_fn=operator.sub, invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.mul, operator_fn=operator.mul, invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.div,
                 valid_dtypes=(asctile.int16, asctile.int32, asctile.int64, asctile.float16, asctile.float32),
                 operator_fn=operator.truediv, invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.maximum, operator_fn=None, invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.minimum, operator_fn=None, invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.pow,
                 valid_dtypes=(asctile.int8, asctile.int16, asctile.int32, asctile.float16, asctile.float32),
                 operator_fn=operator.pow, invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.equal, valid_dtypes=compare_valid_dtypes, operator_fn=operator.eq,
                 invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.not_equal, valid_dtypes=compare_valid_dtypes, operator_fn=operator.ne,
                 invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.greater, valid_dtypes=compare_valid_dtypes, operator_fn=operator.gt,
                 invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.greater_equal, valid_dtypes=compare_valid_dtypes, operator_fn=operator.ge,
                 invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.less, valid_dtypes=compare_valid_dtypes, operator_fn=operator.lt,
                 invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.less_equal, valid_dtypes=compare_valid_dtypes, operator_fn=operator.le,
                 invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.bitwise_and, valid_dtypes=bitwise_valid_dtypes, operator_fn=operator.and_,
                 invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.bitwise_or, valid_dtypes=bitwise_valid_dtypes, operator_fn=operator.or_,
                 invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.bitwise_xor, valid_dtypes=bitwise_valid_dtypes, operator_fn=operator.xor,
                 invalid_cases=common_invalid_cases),
    BinaryOpSpec(fn=asctile.left_shift, valid_dtypes=shift_valid_dtypes, supports_tile_tile=False,
                 supports_scalar_tile=False, operator_fn=operator.lshift, invalid_cases=shift_invalid_cases),
    BinaryOpSpec(fn=asctile.right_shift, valid_dtypes=shift_valid_dtypes, supports_tile_tile=False,
