...
// CHECK-NEXT:    %21 = arith.maxsi %20, %c0_i32 : i32
// CHECK-NEXT:    %22 = arith.minsi %9, %21 : i32
...
// CHECK-NEXT:      %27 = ascendc.construct !ascendc.nd2nz_params(%c1_i32, %c1_i32, %10, %c0_i32, %10, %c16_i32, %c1_i32, %c0_i32) [ui16, ui16, ui32, ui64, ui32, ui16, ui16, ui64] : i32, i32, i32, i32, i32, i32, i32, i32
...
// CHECK-NEXT:  } else {
// CHECK-NEXT:    %20 = ascendc.construct !ascendc.nd2nz_params(%c1_i32, %9, %10, %c0_i32, %arg2, %c16_i32, %c1_i32, %c0_i32) [ui16, ui16, ui32, ui64, ui32, ui16, ui16, ui64] : i32, i32, i32, i32, i32, i32, i32, i32
// CHECK-NEXT:    ascendc.data_copy_l2 %5, %4, %20 : !ascendc.local_tensor<16x64xf16>, !ascendc.global_tensor<?x?xf16>, !ascendc.nd2nz_params
// CHECK-NEXT:  }
// CHECK-NEXT:  %12 = arith.muli %9, %c2_i32 : i32
// CHECK-NEXT:  %13 = arith.ceildivsi %12, %c32_i32 : i32
// CHECK-NEXT:  %14 = arith.muli %13, %c32_i32 : i32
// CHECK-NEXT:  %15 = arith.divsi %14, %c2_i32 : i32
// CHECK-NEXT:  %16 = arith.muli %15, %c128_i32 : i32
...
// CHECK-NEXT:    %20 = arith.muli %15, %c16_i32 : i32
// CHECK-NEXT:    %21 = arith.subi %c16_i32, %15 : i32
// CHECK-NEXT:    %22 = ascendc.local_tensor.subindex %5[%20] : !ascendc.local_tensor<16x64xf16>, i32, !ascendc.local_tensor<16x64xf16>
// CHECK-NEXT:    %23 = ascendc.construct !ascendc.init_const_value_params(%c4_i32, %21, %15, %c0_i32) [ui16, ui16, ui16, f16] : i32, i32, i32, i32
...
// CHECK-NEXT:  %13 = arith.ceildivsi %12, %c32_i32 : i32
// CHECK-NEXT:  %14 = arith.muli %13, %c32_i32 : i32
// CHECK-NEXT:  %15 = arith.divsi %14, %c4_i32 : i32
// CHECK-NEXT:  %16 = arith.muli %15, %c256_i32 : i32
// CHECK-NEXT:  %17 = arith.subi %c4096_i32, %16 : i32
// CHECK-NEXT:  %18 = arith.divsi %17, %c32_i32 : i32
// CHECK-NEXT:  %19 = arith.cmpi sgt, %18, %c0_i32 : i32
// CHECK-NEXT:  scf.if %19 {
// CHECK-NEXT:    %20 = arith.muli %15, %c8_i32 : i32
// CHECK-NEXT:    %21 = arith.subi %c16_i32, %15 : i32
// CHECK-NEXT:    %22 = ascendc.local_tensor.subindex %5[%20] : !ascendc.local_tensor<16x64xf32>, i32, !ascendc.local_tensor<16x64xf32>
// CHECK-NEXT:    %23 = ascendc.construct !ascendc.init_const_value_params(%c8_i32, %21, %15, %c0_i32) [ui16, ui16, ui16, f32] : i32, i32, i32, i32
