...
// CHECK-LABEL: func.func @lower_cmp(%arg0: tensor<16xf32, #asctile.local<UB>>, %arg1: tensor<16xf32, #asctile.local<UB>>) -> tensor<16xi1, #asctile.local<UB>> {
...
// CHECK-NEXT:  return
// CHECK-NEXT:}
func.func @lower_cmp(%arg0: tensor<16xf32, #asctile.local<UB>>, %arg1: tensor<16xf32, #asctile.local<UB>>) -> tensor<16xi1, #asctile.local<UB>> {
  %0 = asctile.cmp "LT" %arg0, %arg1 : tensor<16xf32, #asctile.local<UB>>
...
func.func @lower_select(%arg0: tensor<32xi1, #asctile.local<UB>>, %arg1: tensor<32xf32, #asctile.local<UB>>, %arg2: tensor<32xf32, #asctile.local<UB>>) -> tensor<32xf32, #asctile.local<UB>> {
  %0 = asctile.select %arg0, %arg1, %arg2 : tensor<32xf32, #asctile.local<UB>>
