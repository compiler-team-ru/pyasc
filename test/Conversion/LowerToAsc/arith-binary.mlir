...
// CHECK-NEXT:  %11 = builtin.unrealized_conversion_cast %10 : !ascendc.local_tensor<16xi32> to tensor<16xi32, #asctile.local<UB>>
// CHECK-NEXT:  return %11 : tensor<16xi32, #asctile.local<UB>>
// CHECK-NEXT:}
