...
// CHECK-NEXT:    %0 = builtin.unrealized_conversion_cast %arg1 : !asctile.tile<16x16xf32, UB> to !ascendc.local_tensor<16x16xf32>
...
// CHECK-NEXT:    %c-896_i32 = arith.constant -896 : i32
// CHECK-NEXT:    %c64_i32 = arith.constant 64 : i32
// CHECK-NEXT:    %c1024_i32 = arith.constant 1024 : i32
// CHECK-NEXT:    %c4_i32 = arith.constant 4 : i32
// CHECK-NEXT:    %c16_i32 = arith.constant 16 : i32
...
// CHECK-NEXT:    %0 = ascendc.local_tensor_auto veccalc() : <32xf32>
...
// CHECK-NEXT:    %c32_i64 = arith.constant 32 : i64
// CHECK-NEXT:    %0 = builtin.unrealized_conversion_cast %arg0 : !asctile.tile<32xf32, UB> to !ascendc.local_tensor<32xf32>
...
// CHECK-NEXT:    %0 = builtin.unrealized_conversion_cast %arg1 : !asctile.tile<16x8xf32, UB> to !ascendc.local_tensor<16x8xf32>
...
// CHECK-NEXT:    %c256_i64 = arith.constant 256 : i64
...
// CHECK-NEXT:   %0 = builtin.unrealized_conversion_cast %arg1 : !asctile.tile<16x1xf32, UB> to !ascendc.local_tensor<16x1xf32>
...
// CHECK-NEXT:    %c32_i32 = arith.constant 32 : i32
// CHECK-NEXT:    %c16_i32 = arith.constant 16 : i32
// CHECK-NEXT:    %0 = builtin.unrealized_conversion_cast %arg0 : !asctile.tile<16x32xf32, UB> to !ascendc.local_tensor<16x32xf32>
...
// CHECK-NEXT:    %0 = builtin.unrealized_conversion_cast %arg0 : !asctile.tile<16x32x8xf32, UB> to !ascendc.local_tensor<16x32x8xf32>
...
// CHECK-NEXT:    %c32_i32 = arith.constant 32 : i32
// CHECK-NEXT:    %c64_i32 = arith.constant 64 : i32
// CHECK-NEXT:    %0 = builtin.unrealized_conversion_cast %arg0 : !asctile.tile<64x32xf32, UB> to !ascendc.local_tensor<64x32xf32>
// CHECK-NEXT:    %1 = ascendc.local_tensor_auto veccalc() : <32xf32>
// CHECK-NEXT:    %2 = builtin.unrealized_conversion_cast %1 : !ascendc.local_tensor<32xf32> to !asctile.tile<32xf32, UB>
