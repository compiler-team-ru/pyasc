...
func.func @transpose_l0a_basic(%arg0: !asctile.tensor<32x128xf16>) -> !asctile.tile<128x32xf16, L0A> {
  ...
  %transpose = asctile.transpose %copy : !asctile.tile<32x128xf16, L0A> to !asctile.tile<128x32xf16, L0A>
...
func.func @transpose_l0b_basic(%arg0: !asctile.tensor<64x32xf16>) -> !asctile.tile<32x64xf16, L0B> {
  ...
  %transpose = asctile.transpose %copy : !asctile.tile<64x32xf16, L0B> to !asctile.tile<32x64xf16, L0B>
...
// CHECK-NEXT: %[[TRANSPOSE:.*]] = asctile.transpose %[[COPY]] : !asctile.tile<32x128xf16, UB> to !asctile.tile<128x32xf16, UB>
...
func.func @transpose_ub_not_transformed(%arg0: !asctile.tensor<32x128xf16>) -> !asctile.tile<128x32xf16, UB> {
  ...
  %transpose = asctile.transpose %copy : !asctile.tile<32x128xf16, UB> to !asctile.tile<128x32xf16, UB>
...
func.func @transpose_l0a_f32(%arg0: !asctile.tensor<16x32xf32>) -> !asctile.tile<32x16xf32, L0A> {
  ...
  %transpose = asctile.transpose %copy : !asctile.tile<16x32xf32, L0A> to !asctile.tile<32x16xf32, L0A>
