...
// RUN: ascir-opt -split-input-file -ascvf-find-vf-group -ascvf-lower-to-reg -canonicalize -cse -ascvf-dispatch-vf-fusion -canonicalize -cse -ascvf-materialize-load-store %s | FileCheck %s
...
// CHECK: ascvf.vf_group
// CHECK:   ascvf.vec_scope {
// CHECK:     ascvf.vf_for %c2 : index {
// CHECK:     ^bb0(%arg1: index):
// CHECK:       ascvf.vf_for %c16 : index {
