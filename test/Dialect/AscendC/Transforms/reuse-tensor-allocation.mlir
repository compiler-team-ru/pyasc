...
// CHECK-LABEL: func.func @reuse_tensor_with_static_shape(%arg0: !ascendc.global_tensor<?xi32>) {
...
// CHECK-NEXT:  %1 = ascendc.local_tensor_auto veccalc() : <333xi32>
...
// CHECK:       %0 = ascendc.local_tensor_auto veccalc() input output : <8xf32>
// CHECK-NEXT:  %1 = ascendc.reinterpret_cast %0 : !ascendc.local_tensor<8xf32> to !ascendc.local_tensor<8xf32>
// CHECK:       %2 = ascendc.local_tensor_auto veccalc() : <8xf32>
...
// CHECK:       %3 = ascendc.local_tensor_auto veccalc() : <8xf32>
// CHECK-NEXT:  scf.for %arg2 = %c0 to %c32 step %c1 {
// CHECK-NEXT:    ascendc.data_copy_l2 %0, %arg0, %c8_i64 : !ascendc.local_tensor<8xf32>, !ascendc.global_tensor<?xf32>, i64
// CHECK-NEXT:    ascendc.add_l3 %2, %0, %3 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>
...
// CHECK-NEXT:    ascendc.add_l3 %1, %1, %3 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>
// CHECK-NEXT:    ascendc.data_copy_l2 %arg1, %1, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<8xf32>, i64
// CHECK-NEXT:  }
// CHECK-NEXT:  return
// CHECK-NEXT:}
...
// CHECK-NEXT:  %2 = ascendc.local_tensor_auto veccalc() : <8xi32>
// CHECK-NEXT:  %3 = ascendc.local_tensor_auto veccalc() : <8xi32>
// CHECK-NEXT:  ascendc.data_copy_l2 %0, %arg0, %c8_i64 : !ascendc.local_tensor<8xi32>, !ascendc.global_tensor<?xi32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %1, %arg0, %c8_i64 : !ascendc.local_tensor<8xi32>, !ascendc.global_tensor<?xi32>, i64
...
// CHECK-LABEL: func.func @reuse_two_tensors_in_data_copy(%arg0: !ascendc.global_tensor<?xf32>, %arg1: !ascendc.global_tensor<?xf32>, %arg2: !ascendc.global_tensor<?xf32>) {
...
// CHECK:       %4 = ascendc.local_tensor_auto veccalc() : <8xf32>
// CHECK-NEXT:  ascendc.add_l3 %2, %0, %4 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>
// CHECK-NEXT:  ascendc.add_l3 %3, %2, %4 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>
// CHECK-NEXT:  ascendc.add_l3 %1, %4, %2 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>
...
// CHECK:       %3 = ascendc.local_tensor_auto veccalc() : <8xf32>
// CHECK-NEXT:  ascendc.data_copy_l2 %3, %arg0, %c8_i64 : !ascendc.local_tensor<8xf32>, !ascendc.global_tensor<?xf32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %0, %arg1, %c8_i64 : !ascendc.local_tensor<8xf32>, !ascendc.global_tensor<?xf32>, i64
// CHECK-NEXT:  %4 = ascendc.local_tensor_auto veccalc() : <8xf32>
// CHECK-NEXT:  scf.for %arg3 = %c0 to %c32 step %c1 {
// CHECK-NEXT:    ascendc.add_l3 %4, %0, %3 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>
// CHECK-NEXT:  }
// CHECK-NEXT:  scf.for %arg3 = %c0 to %c32 step %c1 {
// CHECK-NEXT:    ascendc.add_l3 %2, %4, %3 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>
// CHECK-NEXT:  }
// CHECK-NEXT:  scf.for %arg3 = %c0 to %c32 step %c1 {
...
// CHECK-LABEL: func.func @noreuse_inside_loop(%arg0: !ascendc.global_tensor<?xf32>, %arg1: !ascendc.global_tensor<?xf32>, %arg2: !ascendc.global_tensor<?xf32>) {
// CHECK:       %0 = ascendc.local_tensor_auto veccalc() : <8xf32>
// CHECK-NEXT:  %1 = ascendc.reinterpret_cast %0 : !ascendc.local_tensor<8xf32> to !ascendc.local_tensor<8xf32>
// CHECK:       %2 = ascendc.local_tensor_auto veccalc() : <8xf32>
...
// CHECK-NEXT:  %4 = ascendc.local_tensor_auto veccalc() : <8xf32>
// CHECK-NEXT:  scf.for %arg3 = %c0 to %c32 step %c1 {
// CHECK-NEXT:    ascendc.add_l3 %3, %0, %2 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>
...
// CHECK-NEXT:    ascendc.add_l3 %1, %0, %3 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>
...
// CHECK-NEXT:  scf.if %true {
// CHECK-NEXT:    ascendc.add_l3 %2, %1, %4 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>
// CHECK-NEXT:  } else {
// CHECK-NEXT:    ascendc.add_l3 %3, %1, %4 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>
// CHECK-NEXT:  }
// CHECK-NEXT:  return
// CHECK-NEXT:}
...
// CHECK-NEXT:  }
// CHECK-NEXT:  %5 = ascendc.local_tensor_auto veccalc() : <8xf32>
// CHECK-NEXT:  ascendc.add_l3 %5, %0, %4 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>
// CHECK-NEXT:  return
// CHECK-NEXT:}
...
// CHECK-LABEL: func.func @reuse_tensors_allocated_outside_loop(%arg0: !ascendc.global_tensor<?xf32>) {
// CHECK:       %0 = ascendc.local_tensor_auto veccalc() : <8xf32>
// CHECK-NEXT:  %1 = ascendc.reinterpret_cast %0 : !ascendc.local_tensor<8xf32> to !ascendc.local_tensor<8xf32>
// CHECK-NEXT:  %2 = ascendc.reinterpret_cast %0 : !ascendc.local_tensor<8xf32> to !ascendc.local_tensor<8xf32>
// CHECK-NEXT:  %3 = ascendc.reinterpret_cast %0 : !ascendc.local_tensor<8xf32> to !ascendc.local_tensor<8xf32>
...
// CHECK-NEXT:  %5 = ascendc.local_tensor_auto veccalc() : <8xf32>
// CHECK-NEXT:  scf.for %arg1 = %c0 to %c32 step %c1 {
// CHECK-NEXT:    ascendc.add_l2 %0, %4, %5, %c8_i64 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, i64
// CHECK-NEXT:    ascendc.mul_l2 %3, %0, %0, %c8_i64 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, i64
// CHECK-NEXT:    ascendc.add_l2 %2, %3, %5, %c8_i64 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, i64
// CHECK-NEXT:    ascendc.mul_l2 %1, %2, %2, %c8_i64 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, i64
// CHECK-NEXT:    ascendc.data_copy_l2 %arg0, %1, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<8xf32>, i64
// CHECK-NEXT:  }
// CHECK-NEXT:  return
// CHECK-NEXT:}
func.func @reuse_tensors_allocated_outside_loop(%arg0: !ascendc.global_tensor<?xf32>) {
  %c0 = arith.constant 0 : index
  %c32 = arith.constant 32 : index
  %c1 = arith.constant 1 : index
  %c8_i64 = arith.constant 8 : i64
  ...
  %5 = ascendc.local_tensor_auto veccalc() : <8xf32>
  scf.for %arg1 = %c0 to %c32 step %c1 {
    ascendc.add_l2 %0, %4, %5, %c8_i64 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, i64
    ascendc.mul_l2 %1, %0, %0, %c8_i64 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, i64
    ascendc.add_l2 %2, %1, %5, %c8_i64 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, i64
    ascendc.mul_l2 %3, %2, %2, %c8_i64 : !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, !ascendc.local_tensor<8xf32>, i64
    ascendc.data_copy_l2 %arg0, %3, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<8xf32>, i64
  }
  return
}

// CHECK-LABEL: func.func @reuse_a1_tensors(%arg0: !ascendc.global_tensor<?xf32>) {
// CHECK:       %0 = ascendc.local_tensor_auto a1() : <16x16xf32>
// CHECK-NEXT:  %1 = ascendc.reinterpret_cast %0 : !ascendc.local_tensor<16x16xf32> to !ascendc.local_tensor<16x16xf32>
// CHECK:       ascendc.data_copy_l2 %0, %arg0, %c8_i64 : !ascendc.local_tensor<16x16xf32>, !ascendc.global_tensor<?xf32>, i64
...
// CHECK-NEXT:  return
// CHECK-NEXT:}
func.func @reuse_a1_tensors(%arg0: !ascendc.global_tensor<?xf32>) {
  %c8_i64 = arith.constant 8 : i64
...
// CHECK-LABEL: func.func @reuse_a2_tensors(%arg0: !ascendc.global_tensor<?xf32>) {
// CHECK:       %0 = ascendc.local_tensor_auto a2() : <16x16xf32>
// CHECK-NEXT:  %1 = ascendc.reinterpret_cast %0 : !ascendc.local_tensor<16x16xf32> to !ascendc.local_tensor<16x16xf32>
// CHECK:       ascendc.data_copy_l2 %0, %arg0, %c8_i64 : !ascendc.local_tensor<16x16xf32>, !ascendc.global_tensor<?xf32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %arg0, %0, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<16x16xf32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %1, %arg0, %c8_i64 : !ascendc.local_tensor<16x16xf32>, !ascendc.global_tensor<?xf32>, i64
...
// CHECK-NEXT:  return
// CHECK-NEXT:}
func.func @reuse_a2_tensors(%arg0: !ascendc.global_tensor<?xf32>) {
  %c8_i64 = arith.constant 8 : i64
  %0 = ascendc.local_tensor_auto a2() : <16x16xf32>
  ascendc.data_copy_l2 %0, %arg0, %c8_i64 : !ascendc.local_tensor<16x16xf32>, !ascendc.global_tensor<?xf32>, i64
  ascendc.data_copy_l2 %arg0, %0, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<16x16xf32>, i64
  %1 = ascendc.local_tensor_auto a2() : <16x16xf32>
  ascendc.data_copy_l2 %1, %arg0, %c8_i64 : !ascendc.local_tensor<16x16xf32>, !ascendc.global_tensor<?xf32>, i64
  ascendc.data_copy_l2 %arg0, %1, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<16x16xf32>, i64
  return
}

// CHECK-LABEL: func.func @reuse_b2_tensors(%arg0: !ascendc.global_tensor<?xf32>) {
// CHECK:       %0 = ascendc.local_tensor_auto b2() : <16x16xf32>
// CHECK-NEXT:  %1 = ascendc.reinterpret_cast %0 : !ascendc.local_tensor<16x16xf32> to !ascendc.local_tensor<16x16xf32>
// CHECK:       ascendc.data_copy_l2 %0, %arg0, %c8_i64 : !ascendc.local_tensor<16x16xf32>, !ascendc.global_tensor<?xf32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %arg0, %0, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<16x16xf32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %1, %arg0, %c8_i64 : !ascendc.local_tensor<16x16xf32>, !ascendc.global_tensor<?xf32>, i64
...
// CHECK-NEXT:  return
// CHECK-NEXT:}
func.func @reuse_b2_tensors(%arg0: !ascendc.global_tensor<?xf32>) {
  %c8_i64 = arith.constant 8 : i64
  %0 = ascendc.local_tensor_auto b2() : <16x16xf32>
  ascendc.data_copy_l2 %0, %arg0, %c8_i64 : !ascendc.local_tensor<16x16xf32>, !ascendc.global_tensor<?xf32>, i64
  ascendc.data_copy_l2 %arg0, %0, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<16x16xf32>, i64
...
// CHECK-LABEL: func.func @reuse_co1_tensors(%arg0: !ascendc.global_tensor<?xf32>) {
// CHECK:       %0 = ascendc.local_tensor_auto co1() {asctile.unroll_iter = 0 : i64} : <64x16xf32>
// CHECK-NEXT:  %1 = ascendc.reinterpret_cast %0 : !ascendc.local_tensor<64x16xf32> to !ascendc.local_tensor<64x16xf32>
// CHECK:       ascendc.data_copy_l2 %0, %arg0, %c8_i64 : !ascendc.local_tensor<64x16xf32>, !ascendc.global_tensor<?xf32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %arg0, %0, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<64x16xf32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %1, %arg0, %c8_i64 : !ascendc.local_tensor<64x16xf32>, !ascendc.global_tensor<?xf32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %arg0, %1, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<64x16xf32>, i64
// CHECK-NEXT:  return
// CHECK-NEXT:}
func.func @reuse_co1_tensors(%arg0: !ascendc.global_tensor<?xf32>) {
  %c8_i64 = arith.constant 8 : i64
  %0 = ascendc.local_tensor_auto co1() {asctile.unroll_iter = 0 : i64} : <64x16xf32>
  ascendc.data_copy_l2 %0, %arg0, %c8_i64 : !ascendc.local_tensor<64x16xf32>, !ascendc.global_tensor<?xf32>, i64
  ascendc.data_copy_l2 %arg0, %0, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<64x16xf32>, i64
  %1 = ascendc.local_tensor_auto co1() {asctile.unroll_iter = 1 : i64} : <64x16xf32>
  ascendc.data_copy_l2 %1, %arg0, %c8_i64 : !ascendc.local_tensor<64x16xf32>, !ascendc.global_tensor<?xf32>, i64
  ascendc.data_copy_l2 %arg0, %1, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<64x16xf32>, i64
  return
}

// CHECK-LABEL: func.func @noreuse_co1_accumulator(%arg0: !ascendc.global_tensor<?xf32>) {
// CHECK:       %0 = ascendc.local_tensor_auto co1() output : <64x16xf32>
// CHECK-NEXT:  %1 = ascendc.local_tensor_auto co1() : <64x16xf32>
// CHECK-NEXT:  %2 = ascendc.local_tensor_auto co1() : <64x16xf32>
// CHECK-NEXT:  scf.for %arg1 = %c0 to %c32 step %c1 {
// CHECK-NEXT:    ascendc.add_l3 %0, %1, %2 : !ascendc.local_tensor<64x16xf32>, !ascendc.local_tensor<64x16xf32>, !ascendc.local_tensor<64x16xf32>
// CHECK-NEXT:  }
// CHECK-NEXT:  ascendc.data_copy_l2 %arg0, %0, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<64x16xf32>, i64
// CHECK-NEXT:  return
// CHECK-NEXT:}
func.func @noreuse_co1_accumulator(%arg0: !ascendc.global_tensor<?xf32>) {
  %c8_i64 = arith.constant 8 : i64
  %c0 = arith.constant 0 : index
  %c32 = arith.constant 32 : index
  %c1 = arith.constant 1 : index
  %0 = ascendc.local_tensor_auto co1() output : <64x16xf32>
  %1 = ascendc.local_tensor_auto co1() : <64x16xf32>
  %2 = ascendc.local_tensor_auto co1() : <64x16xf32>
  scf.for %arg1 = %c0 to %c32 step %c1 {
    ascendc.add_l3 %0, %1, %2 : !ascendc.local_tensor<64x16xf32>, !ascendc.local_tensor<64x16xf32>, !ascendc.local_tensor<64x16xf32>
  }
  ascendc.data_copy_l2 %arg0, %0, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<64x16xf32>, i64
  return
}
...
// CHECK-NEXT:  ascendc.data_copy_l2 %arg0, %0, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<16x16xf32>, i64
// CHECK-NEXT:  %1 = ascendc.local_tensor_auto b2() : <16x16xf32>
// CHECK-NEXT:  ascendc.data_copy_l2 %1, %arg0, %c8_i64 : !ascendc.local_tensor<16x16xf32>, !ascendc.global_tensor<?xf32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %arg0, %1, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<16x16xf32>, i64
// CHECK-NEXT:  return
// CHECK-NEXT:}
...
// CHECK-LABEL: func.func @reuse_matmul_pattern(%arg0: !ascendc.global_tensor<?xf32>, %arg1: !ascendc.global_tensor<?xf32>) {
// CHECK:       %0 = ascendc.local_tensor_auto a2() input {asctile.unroll_iter = 0 : i64} : <64x16xf32>
// CHECK-NEXT:  %1 = ascendc.reinterpret_cast %0 : !ascendc.local_tensor<64x16xf32> to !ascendc.local_tensor<64x16xf32>
// CHECK-NEXT:  %2 = ascendc.local_tensor_auto b2() input {asctile.unroll_iter = 0 : i64} : <16x16xf32>
// CHECK-NEXT:  %3 = ascendc.reinterpret_cast %2 : !ascendc.local_tensor<16x16xf32> to !ascendc.local_tensor<16x16xf32>
// CHECK:       %4 = ascendc.local_tensor_auto co1() output : <64x16xf32>
// CHECK-NEXT:  ascendc.data_copy_l2 %0, %arg0, %c8_i64 : !ascendc.local_tensor<64x16xf32>, !ascendc.global_tensor<?xf32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %2, %arg0, %c8_i64 : !ascendc.local_tensor<16x16xf32>, !ascendc.global_tensor<?xf32>, i64
// CHECK-NEXT:  ascendc.add_l3 %4, %0, %2 {asctile.unroll_iter = 0 : i64} : !ascendc.local_tensor<64x16xf32>, !ascendc.local_tensor<64x16xf32>, !ascendc.local_tensor<16x16xf32>
// CHECK-NEXT:  ascendc.data_copy_l2 %1, %arg0, %c8_i64 : !ascendc.local_tensor<64x16xf32>, !ascendc.global_tensor<?xf32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %3, %arg0, %c8_i64 : !ascendc.local_tensor<16x16xf32>, !ascendc.global_tensor<?xf32>, i64
// CHECK-NEXT:  ascendc.add_l3 %4, %1, %3 {asctile.unroll_iter = 1 : i64} : !ascendc.local_tensor<64x16xf32>, !ascendc.local_tensor<64x16xf32>, !ascendc.local_tensor<16x16xf32>
// CHECK-NEXT:  ascendc.data_copy_l2 %arg1, %4, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<64x16xf32>, i64
// CHECK-NEXT:  return
// CHECK-NEXT:}
func.func @reuse_matmul_pattern(%arg0: !ascendc.global_tensor<?xf32>, %arg1: !ascendc.global_tensor<?xf32>) {
  %c8_i64 = arith.constant 8 : i64
  %co1 = ascendc.local_tensor_auto co1() output : <64x16xf32>
  %a2_0 = ascendc.local_tensor_auto a2() input {asctile.unroll_iter = 0 : i64} : <64x16xf32>
  %a2_1 = ascendc.local_tensor_auto a2() input {asctile.unroll_iter = 1 : i64} : <64x16xf32>
  %b2_0 = ascendc.local_tensor_auto b2() input {asctile.unroll_iter = 0 : i64} : <16x16xf32>
  %b2_1 = ascendc.local_tensor_auto b2() input {asctile.unroll_iter = 1 : i64} : <16x16xf32>
  ...
  ascendc.add_l3 %co1, %a2_0, %b2_0 {asctile.unroll_iter = 0 : i64} : !ascendc.local_tensor<64x16xf32>, !ascendc.local_tensor<64x16xf32>, !ascendc.local_tensor<16x16xf32>
  ...
  ascendc.add_l3 %co1, %a2_1, %b2_1 {asctile.unroll_iter = 1 : i64} : !ascendc.local_tensor<64x16xf32>, !ascendc.local_tensor<64x16xf32>, !ascendc.local_tensor<16x16xf32>
  ascendc.data_copy_l2 %arg1, %co1, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<64x16xf32>, i64
  return
}

// CHECK-LABEL: func.func @reuse_a2_cube_aligned(%arg0: !ascendc.global_tensor<?xf32>) {
// CHECK:       %0 = ascendc.local_tensor_auto a2() : <1x32xf32>
// CHECK-NEXT:  %1 = ascendc.reinterpret_cast %0 : !ascendc.local_tensor<1x32xf32> to !ascendc.local_tensor<16x16xf32>
// CHECK:       ascendc.data_copy_l2 %0, %arg0, %c8_i64 : !ascendc.local_tensor<1x32xf32>, !ascendc.global_tensor<?xf32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %arg0, %0, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<1x32xf32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %1, %arg0, %c8_i64 : !ascendc.local_tensor<16x16xf32>, !ascendc.global_tensor<?xf32>, i64
// CHECK-NEXT:  ascendc.data_copy_l2 %arg0, %1, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<16x16xf32>, i64
// CHECK-NEXT:  return
// CHECK-NEXT:}
func.func @reuse_a2_cube_aligned(%arg0: !ascendc.global_tensor<?xf32>) {
  %c8_i64 = arith.constant 8 : i64
  %0 = ascendc.local_tensor_auto a2() : <1x32xf32>
  ascendc.data_copy_l2 %0, %arg0, %c8_i64 : !ascendc.local_tensor<1x32xf32>, !ascendc.global_tensor<?xf32>, i64
  ascendc.data_copy_l2 %arg0, %0, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<1x32xf32>, i64
  %1 = ascendc.local_tensor_auto a2() : <16x16xf32>
  ascendc.data_copy_l2 %1, %arg0, %c8_i64 : !ascendc.local_tensor<16x16xf32>, !ascendc.global_tensor<?xf32>, i64
  ascendc.data_copy_l2 %arg0, %1, %c8_i64 : !ascendc.global_tensor<?xf32>, !ascendc.local_tensor<16x16xf32>, i64
  return
