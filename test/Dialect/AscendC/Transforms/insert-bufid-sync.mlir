...
// CHECK-NEXT: ascendc.load_data_g2l
...
// CHECK: scf.for
// CHECK: ascendc.set_flag mte3_mte2
...
// CHECK: ascendc.tbuf.get_tensor
// CHECK-NEXT: ascendc.reinterpret_cast
// CHECK-NEXT: ascendc.reinterpret_cast
// CHECK-NEXT: ascendc.get_buf pipe_v, 0
// CHECK-NEXT: ascendc.add_l2
// CHECK-NEXT: ascendc.rls_buf pipe_v, 0
...
// CHECK: ascendc.tbuf.get_tensor
// CHECK-NEXT: ascendc.local_tensor.subindex
// CHECK-NEXT: ascendc.get_buf pipe_v, 0
// CHECK-NEXT: ascendc.add_l2
// CHECK-NEXT: ascendc.rls_buf pipe_v, 0
// CHECK-NEXT: return
...
// CHECK-NEXT: ascendc.wait_flag mte3_mte1
// CHECK: }
// CHECK: ascendc.get_buf pipe_mte3, 2
// CHECK-NEXT: ascendc.data_copy_l2
// CHECK-NEXT: ascendc.rls_buf pipe_mte3, 2
// CHECK-NEXT: return
// CHECK-NEXT:}
...
// CHECK-NEXT: ascendc.local_tensor.set_value
...
// CHECK-NEXT: ascendc.rls_buf pipe_mte2, 1
// CHECK-NEXT: ascendc.get_buf pipe_s, 0
// CHECK-NEXT: ascendc.local_tensor.get_value
// CHECK-NEXT: ascendc.rls_buf pipe_s, 0
// CHECK-NEXT: ascendc.get_buf pipe_s, 0
// CHECK-NEXT: ascendc.local_tensor.set_value
// CHECK-NEXT: ascendc.rls_buf pipe_s, 0
