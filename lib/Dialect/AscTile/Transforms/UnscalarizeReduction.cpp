...
struct ConvertSplat : OpConversionPattern<asctile::SplatOp> {
    ...
    LogicalResult matchAndRewrite(asctile::SplatOp op, asctile::SplatOp::Adaptor adaptor,
                                  ConversionPatternRewriter &rewriter) const override
    {
...
bool allUnscalarizableUsers(Operation *op)
{
    return llvm::all_of(op->getUsers(), [](Operation *user) {
        return isa<asctile::AddSOp, asctile::SubSOp, asctile::MulSOp, asctile::DivSOp, asctile::MinSOp, asctile::MaxSOp,
