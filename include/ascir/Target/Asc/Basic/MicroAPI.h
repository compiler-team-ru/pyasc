...
LogicalResultForT<BinaryMicroOp, ascendc::AddMicroOp, ascendc::AndMicroOp, ascendc::DivMicroOp,
                  ascendc::FusedAbsSubMicroOp, ascendc::FusedExpSubMicroOp, ascendc::FusedMulDstAddMicroOp,
                  ascendc::SubMicroOp, ascendc::MaxMicroOp, ascendc::MinMicroOp, ascendc::MulMicroOp,
                  ascendc::MulAddDstMicroOp, ascendc::OrMicroOp, ascendc::PreluMicroOp, ascendc::XorMicroOp>
...
LogicalResultForT<UnaryMicroOp, ascendc::AbsMicroOp, ascendc::ExpMicroOp, ascendc::LnMicroOp, ascendc::LogMicroOp,
                  ascendc::Log10MicroOp, ascendc::MaskNotMicroOp, ascendc::NegMicroOp, ascendc::NotMicroOp,
                  ascendc::ReluMicroOp, ascendc::SqrtMicroOp>
